...
if (strlen('[#]customer.md5[#]') == 32)
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', '[#]customer.md5[#]');
}
else
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', md5(strtoupper('[#]customer.md5[#]')));
}
	...
	<table class="tborder" cellpadding="0" cellspacing="0" border="0" width="450" align="center"><tr><td>
		...
		<tr valign="bottom">
			...
			<td>
				...
				<?php echo "<!--<branding>-->vBulletin {$vbulletin->options['templateversion']} <!--</branding>-->$pagetitle"; ?><br />
				&nbsp;
			</td>
		</tr>
		</table>
