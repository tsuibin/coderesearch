...
CREATE TABLE " . TABLE_PREFIX . "groupmessage (
  ...
  title VARCHAR(255) NOT NULL DEFAULT '',
  titleindex VARCHAR(255) NOT NULL DEFAULT '',
  pagetext MEDIUMTEXT,
  ...
  FULLTEXT KEY gm_ft (titleindex, pagetextindex)
) $enginetype=MyISAM
";
...
CREATE TABLE " . TABLE_PREFIX . "socialgroup (
	...
	nameindex VARCHAR(255) NOT NULL DEFAULT '',
	description TEXT,
	...
	FULLTEXT KEY name (nameindex, descriptionindex)
) $enginetype=MyISAM
";
...
$schema['INSERT']['query']['bookmarksite'] = "
	...
	VALUES
		('Google',      1, 10, 'bookmarksite_google.gif',      'http://www.google.com/bookmarks/mark?op=edit&amp;output=popup&amp;bkmk={URL}&amp;annotation={TITLE}'),
		('del.icio.us', 1, 20, 'bookmarksite_delicious.gif',   'http://del.icio.us/post?url={URL}&amp;title={TITLE}'),
		('Digg',        0, 30, 'bookmarksite_digg.gif',        'http://digg.com/submit?phase=2&amp;url={URL}&amp;title={TITLE}'),
		('StumbleUpon', 0, 40, 'bookmarksite_stumbleupon.gif', 'http://www.stumbleupon.com/submit?url={URL}&amp;title={TITLE}'),
		('百度搜藏',    1, 50, 'bookmarksite_baidu.gif',       'http://cang.baidu.com/do/add?it={TITLE}&amp;iu={URL}&amp;dc=&amp;fr=ien#nw=1'),
		('QQ 书签',     1, 60, 'bookmarksite_qq.gif',              'http://shuqian.qq.com/post?from=3&amp;title={TITLE}&amp;uri={URL}&amp;jumpback=2&amp;noui=1'),
		('雅虎收藏',    1, 70, 'bookmarksite_yahoo.gif',       'http://myweb.cn.yahoo.com/popadd.html?url={URL}&amp;title={TITLE}'),
		('饭否',        0, 80, 'bookmarksite_fanfou.gif',      'http://fanfou.com/share.new?u={URL}&amp;t={TITLE}'),
		('365Key 网摘', 0, 90, 'bookmarksite_365key.gif',      'http://www.365key.com/storeit.aspx?t={TITLE}&amp;u={URL}'),
		('天极网摘',    0, 100, 'bookmarksite_yesky.gif',      'http://hot.yesky.com/dp.aspx?t={TITLE}&amp;u={URL}'),
		('POCO 网摘',   0, 110, 'bookmarksite_poco.gif',       'http://my.poco.cn/fav/storeIt.php?t={TITLE}&amp;u={URL}'),
		('和讯网摘',    0, 120, 'bookmarksite_hexun.gif',      'http://bookmark.hexun.com/post.aspx?title={TITLE}&amp;url={URL}'),
		('做啥',        0, 130, 'bookmarksite_zuosa.gif',      'http://zuosa.com/collect/Collect.aspx?t={TITLE}&amp;u={URL}'),
		('i2Key 网摘',  0, 140, 'bookmarksite_i2key.gif',      'http://www.i2key.com/StoreIt.aspx?t={TITLE}&amp;u={URL}'),
		('搜狐网摘',    0, 150, 'bookmarksite_sohuz.gif',      'http://z.sohu.com/storeit.do?t={TITLE}&amp;u={URL}'),
		('Technorati',  0, 160, 'bookmarksite_technorati.gif', 'http://technorati.com/faves?sub=addfavbtn&amp;add={URL}'),
		('Yahoo!奇摩書籤',  0, 170, 'bookmarksite_yahoo.gif',  'http://tw.myweb2.search.yahoo.com/my...8&amp;t={TITLE}')
";
