...
if ($vbulletin->GPC['step'] == 3)
{
	...
	if ($upgrade->field_exists('groupmessage', 'groupid'))
	{
		...
		$upgrade->add_field(
			sprintf($upgrade_phrases['upgrade_300b3.php']['altering_x_table'], 'groupmessage', 1, 3),
			'groupmessage',
			'discussionid',
			'int',
			FIELD_DEFAULTS
		...
		$upgrade->add_field(
			sprintf($upgrade_phrases['upgrade_300b3.php']['altering_x_table'], 'groupmessage', 2, 3),
			'groupmessage',
			'titleindex',
			'varchar',
			array('length' => 255)
		...
		$upgrade->add_field(
			sprintf($upgrade_phrases['upgrade_300b3.php']['altering_x_table'], 'groupmessage', 3, 3),
			'groupmessage',
			'pagetextindex',
			'mediumtext',
			FIELD_DEFAULTS
		...
		$upgrade->add_index(
			...
			'groupmessage',
			'gm_ft',
			array('titleindex', 'pagetextindex'),
			'fulltext'
		);
