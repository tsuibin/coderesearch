...
class vB_DataManager_SocialGroup extends vB_DataManager
{
	...
	*/
	var $validfields = array(
		...
		'nameindex'     => array(TYPE_STR,        REQ_NO),
		'description'      => array(TYPE_NOHTMLCOND, REQ_NO,   VF_METHOD),
		'descriptionindex' => array(TYPE_STR,        REQ_NO),
...
// vB China Start
		$this->set('nameindex', implode(' ', sp_str($this->fetch_field('name'))));
		$this->set('descriptionindex', implode(' ', sp_str($this->fetch_field('description'))));
// vB China End
