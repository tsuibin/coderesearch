...
class vB_DataManager_GroupMessage extends vB_DataManager
{
	...
	*/
	var $validfields = array(
		...
		'titleindex'     => array(TYPE_NOHTMLCOND, REQ_NO),
...
// vB China Start
		$this->set('titleindex', implode(' ', sp_str($this->fetch_field('title'))));
		$this->set('pagetextindex', implode(' ', sp_str($this->fetch_field('pagetext'))));
// vB China End
